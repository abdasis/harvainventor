...
<html lang="en">
  ...
  <body>
        ...
        <div class="container bg-transparent p-3">
            ...
            <p>
                Pihak Pertama dan Pihak Kedua dalam kedudukan masing-masing seperti telah ditengkan diatas, pada hari ini ***{{ date('D') }} tanggal {{ date('d F Y') }}*** jam {{ date('h:m') }} WIB btertemapt di *** Rumah Kedua, *** Dengan sada dan sukarela menyatakan telah membuat perjanjian utang piutang dengan ketentuan-ketentuan yang disepakatai bersama sebagai berikut:
            </p>
            <br>
            ...
            <ol type="1">
                <li>
                    <p>
                        Pihak Pertama setuju memberikan pinjaman kepada pihak Kedua sebesar ***Rp. {{ number_format($nasabah->total_pinjaman, 2,',','.') }},- ({{ terbilang($nasabah->total_pinjaman) }} Rupiah)*** yaitu jumlah yang telah diputuskan dalam Musyawarah Tim Pendanaan atau Musyawarah Khusus Perguliran pada tanggal ***{{ date('d F Y', strtotime($nasabah->created_at)) }}*** berdasarkan Permohonan dari Pihak Kedua dan para Pemberi Kuasa yang dilakukan secara kelompok sesuai Surat Permohonan Kredit dan hasil verifikasi kelompok
                    </p>
                </li>
                <li>
